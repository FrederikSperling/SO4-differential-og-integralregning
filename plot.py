...
Integral = Integralregning(-100, 10, 100, 1, 6, 5, 2)
...
class graf:
    def __init__(self):
        ...
        fig, ax = plt.subplots()
        ax.plot(self.x, self.y, 'black', linewidth=2)
        ...
        ax.text(0.5 * (Integral.a + Integral.b), 100, r"Areal er: "+str(Integral.sumAreal), horizontalalignment='center',
                fontsize=10)
        plt.xlabel('x')
        plt.ylabel('y')
